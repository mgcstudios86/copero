...
describe('MGC-2131 / PR #482 — country Pressable sin hitSlop (regresión MGC-2081)', () => {
  ...
  it('El comentario MGC-2081 menciona los 3 factores del bug (overflow + hitSlop + ScrollView)', () => {
    ...
    // `causa raíz del bug MGC-2081 hitSlop` (que precede `*/}` y no
    // documenta ScrollView). Cortar en próximo `// MGC-NNNN` (cualquier
    // bloque siguiente) o fin de comentario, ventana 3000 chars cubre el
    // bloque canónico completo (~25 líneas).
