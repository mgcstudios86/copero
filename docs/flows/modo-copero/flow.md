...
- **Pantalla / Componente**: `src/features/copero/bracket.ts`.
...
- **Resultado esperado**: Bracket renderizado en pantalla `copero/bracket.tsx` con 5 rondas visibles (32, 16, 8, semis, final).
