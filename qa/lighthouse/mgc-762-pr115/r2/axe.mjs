...
await browser.close();
fs.writeFileSync(`${cwd}/qa/lighthouse/mgc-762-pr115/r2/axe-summary.json`, JSON.stringify(out, null, 2));
fs.writeFileSync(`${cwd}/qa/lighthouse/mgc-762-pr115/r2/axe-full.json`, JSON.stringify(results, null, 2));
